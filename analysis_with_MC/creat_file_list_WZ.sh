...
DIRECTORIES=(
    "/eos/user/p/pravesh/run3/2023/MC/WZ_TuneCP5_13p6TeV_pythia8/WZ/250821_151159/0000/"
)

# Create output directory for file lists
mkdir -p filelists_WZ
...
create_file_list() {
    ...
    local filename="filelists_WZ/filelist_${dirname}_${subdir}_job${index}.txt"
