...
DIRECTORIES=(
    "/eos/user/p/pravesh/run3/2023/MC/TTG-1Jets_PTG-200_TuneCP5_13p6TeV_amcatnloFXFXold-pythia8/TTG/250821_151754/0000/"
)

# Create output directory for file lists
mkdir -p filelists_TTG
...
create_file_list() {
    ...
    local filename="filelists_TTG/filelist_${dirname}_${subdir}_job${index}.txt"
