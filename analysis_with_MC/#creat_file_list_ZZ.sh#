...
DIRECTORIES=(
    "/eos/user/p/pravesh/run3/2023/MC/ZZ_TuneCP5_13p6TeV_pythia8/ZZ/250821_150857/0000/"
)

# Create output directory for file lists
mkdir -p filelists_ZZ
...
create_file_list() {
    ...
    local filename="filelists_ZZ/filelist_${dirname}_${subdir}_job${index}.txt"
