...
DIRECTORIES=(
    "/eos/user/p/pravesh/run3/2023/MC/GJ_PTG-200to400_TuneCP5_13p6TeV_amcatnlo-pythia8/GJ_PTG-200to400/250821_145805/0000/"
    "/eos/user/p/pravesh/run3/2023/MC/GJ_PTG-400to600_TuneCP5_13p6TeV_amcatnlo-pythia8/GJ_PTG-400to600/250821_150056/0000/"
    "/eos/user/p/pravesh/run3/2023/MC/GJ_PTG-600_TuneCP5_13p6TeV_amcatnlo-pythia8/GJ_PTG-600/250821_150343/0000/"
)

# Create output directory for file lists
mkdir -p filelists_GJ
...
create_file_list() {
    ...
    local filename="filelists_GJ/filelist_${dirname}_${subdir}_job${index}.txt"
